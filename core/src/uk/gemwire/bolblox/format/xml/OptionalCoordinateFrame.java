...
@XmlRootElement(name = "OptionalCoordinateFrame")
public class OptionalCoordinateFrame {

    @XmlElement(name = "CFrame", required = true)
    protected CFrame cFrame;
     ...
     *     
     */
    public void setCFrame(CFrame value) {
        this.cFrame = value;
    }
